...
public:
   ...
   SatResult solve_bmc(MapleCOMSPS::vec<int> & cls, MapleCOMSPS::vec<MapleCOMSPS::Lit> &strengthenedCls);
   ...
   void getTrailClauses(vector<ClauseExchange *> & clauses) { exit(1); };
   ...
   bool strengthened_bmc(MapleCOMSPS::vec<int> & cls, MapleCOMSPS::vec<MapleCOMSPS::Lit> & outCls);
