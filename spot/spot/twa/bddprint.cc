...
namespace spot
{
  ...
  std::ostream&
  bdd_print_cnf_formula(std::ostream& os, const bdd_dict_ptr& d, bdd b)
  {
    return print_(os, bdd_to_cnf_formula(b, d));
  }
  ...
  std::string
  bdd_format_cnf_formula(const bdd_dict_ptr& d, bdd b)
  {
    std::ostringstream os;
    bdd_print_cnf_formula(os, d, b);
    return os.str();
  }
